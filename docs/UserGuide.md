...
- Some commands such as `delete` and `edit` can _only be executed from certain screens_. These requirements will be further explained in the descriptions of the commands below.
